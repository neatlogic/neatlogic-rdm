...
@Component
public class CreateDateAttrHandler implements IAttrValueHandler {
    @Override
    public String getName() {
        return SystemAttrType.CREATE_DATE.getValue();
    }

    @Override
    public String getLabel() {
        return SystemAttrType.CREATE_DATE.getLabel();
    }

    @Override
    public String getType() {
        return SystemAttrType.CREATE_DATE.getType();
    }
