...
@Component
public class TextareaAttrHandler implements IAttrValueHandler {
    @Override
    public String getName() {
        return AttrType.TEXTAREA.getValue();
    }

    @Override
    public String getLabel() {
        return AttrType.TEXTAREA.getLabel();
    }

    @Override
    public String getType() {
        return AttrType.TEXTAREA.getType();
    }
