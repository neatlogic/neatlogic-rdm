...
@Component
public class StatusAttrHandler implements IAttrValueHandler {
    @Override
    public String getName() {
        return SystemAttrType.STATUS.getValue();
    }

    @Override
    public String getLabel() {
        return SystemAttrType.STATUS.getLabel();
    }

    @Override
    public String getType() {
        return SystemAttrType.STATUS.getType();
    }
