...
@Component
public class SelectAttrHandler implements IAttrValueHandler {
    @Override
    public String getName() {
        return AttrType.SELECT.getValue();
    }

    @Override
    public String getLabel() {
        return AttrType.SELECT.getLabel();
    }

    @Override
    public String getType() {
        return AttrType.SELECT.getType();
    }

    @Override
    public String getImportHelp() {
        return "请输入合法选项，多个选项用,分隔";
    }
