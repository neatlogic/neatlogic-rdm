...
@Component
public class EndDateAttrHandler implements IAttrValueHandler {
    @Override
    public String getName() {
        return AttrType.ENDDATE.getValue();
    }

    @Override
    public String getLabel() {
        return AttrType.ENDDATE.getLabel();
    }

    @Override
    public String getType() {
        return AttrType.ENDDATE.getType();
    }
