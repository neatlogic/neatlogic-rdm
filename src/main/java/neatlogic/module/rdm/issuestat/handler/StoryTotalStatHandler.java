...
@Component
public class StoryTotalStatHandler extends IssueStatHandlerBase implements IIssueStatHandler {
    @Override
    public String getStatKey() {
        return AppStatAttrType.STORY_TOTAL.getValue();
    }

    @Override
    public IssueStatResultVo calculate(IssueStatContextVo context) {
        IssueStatResultVo resultVo = createResult(context, "metric", "需求总数");
        resultVo.setValue(getTotalCount(context));
        return resultVo;
    }
}
