...
@Component
public class StoryOverdueStatHandler extends IssueStatHandlerBase implements IIssueStatHandler {
    @Override
    public String getStatKey() {
        return AppStatAttrType.STORY_OVERDUE.getValue();
    }

    @Override
    public IssueStatResultVo calculate(IssueStatContextVo context) {
        IssueStatResultVo resultVo = createResult(context, "metric", "逾期需求总数");
        resultVo.setValue(issueMapper.getIssueOverviewOverdueCount(toIssueVo(context)));
        return resultVo;
    }
}
