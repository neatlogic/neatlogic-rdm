...
@Component
public class BugOpenStatHandler extends IssueStatHandlerBase implements IIssueStatHandler {
    @Override
    public String getStatKey() {
        return AppStatAttrType.BUG_OPEN.getValue();
    }

    @Override
    public IssueStatResultVo calculate(IssueStatContextVo context) {
        IssueStatResultVo resultVo = createResult(context, "metric", "未关闭缺陷数");
        resultVo.setValue(getTotalCount(context) - getDoneCount(context));
        return resultVo;
    }
}
