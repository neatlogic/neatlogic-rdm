...
@Transactional
public class ImportIssueExcelApi extends PrivateBinaryStreamApiComponentBase {
    ...
    public Object myDoService(JSONObject paramObj, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        return issueExcelService.importIssue(paramObj.getLong("appId"), multipartFileList.get(0));
    }
}
